...
var check_availability_by_dept = function(frm){
	if(frm.doc.department && frm.doc.appointment_date){
		frappe.call({
			method:
			"smarte.medical.doctype.appointment.appointment.check_available_by_dept",
...
var check_availability_on_date = function(frm){
	if(frm.doc.physician && frm.doc.appointment_date){
		frappe.call({
			method:
			"smarte.medical.doctype.appointment.appointment.check_available_on_date",
...
var btn_update_status = function(frm, status){
	...
	frappe.call({
		method:
		"smarte.medical.doctype.appointment.appointment.update_status",
...
var btn_invoice_consultation = function(frm){
	...
	frappe.call({
		method:
		"smarte.medical.doctype.appointment.appointment.create_consultation_invoice",
