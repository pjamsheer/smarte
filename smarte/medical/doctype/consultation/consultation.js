...
var btn_invoice_drug = function(frm){
	var doc = frm.doc;
	frappe.call({
		method:"smarte.medical.doctype.consultation.consultation.create_drug_invoice",
...
var btn_admit_patient = function(frm){
	var doc = frm.doc;
	frappe.call({
		method:"smarte.medical.doctype.consultation.consultation.admit_patient",
		args: {consultationId: doc.name},
		callback: function(data){
			if(!data.exc){
...
var btn_invoice_lab_test = function(frm){
	var doc = frm.doc;
	frappe.call({
		method:"smarte.medical.doctype.consultation.consultation.create_lab_test_invoice",
		args: {consultationId: doc.name},
		callback: function(data){
			if(!data.exc){
				var doclist = frappe.model.sync(data.message);
