...
var mark_as_completed = function(frm){
	...
	frappe.call({
		method:"smarte.medical.doctype.invoice_test_report.invoice_test_report.mark_as_completed",
		...
		callback: function(r) {
			if(r.exc) {msgprint(r.exc); return; }
				...
				for(result in doc.lab_test_presult){
					if(doc.lab_test_presult[result].sms_sent==0){
						frappe.call({
							method: 		"smarte.medical.doctype.lab_procedure.lab_procedure.update_lab_procedure_print_sms_email_status",
							args: {
